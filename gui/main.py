...
from SupplyOpts import SupplyOpts, AddMedication, SearchMedication, AddEquipment, SearchEquipment, SuppliesforProcedure
...
class App(ctk.CTk):
    def __init__(self, *args, **kwargs):
        ...
        self.frames = {}
        for F in (StartPage, PatientOpts, AddPatient, PatientByName, SupplyOpts, AddMedication, SearchMedication, AddEquipment, SearchEquipment,  SuppliesforProcedure):
